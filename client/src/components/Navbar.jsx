...
function Navbar() {
  ...
  return (
    <nav className='navigationBar d-flex flex-sm-row flex-lg-column justify-content-between align-items-center' >
        ...
        <span className="navigationBar__button-container d-lg-flex flex-lg-column justify-content-center align-items-center">
